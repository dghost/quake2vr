...
void (APIENTRY * qglGetActiveUniformARB) (GLhandleARB programObj, GLuint index, GLsizei maxLength, GLsizei* length, GLint *size, GLenum *type, GLcharARB *name);
...
void (APIENTRY * qglUniform1ivARB) (GLint location, GLsizei count, const GLint* value);
