...
static int32_t		r_screendownsamplingtexture_size;
static int32_t		screen_texture_width, screen_texture_height;
//static int32_t		r_screenbackuptexture_size;
static int32_t      r_screenbackuptexture_width, r_screenbackuptexture_height;

//current refdef size:
static int32_t	curView_x;
static int32_t	curView_y;
static int32_t	curView_width;
static int32_t	curView_height;

// texture coordinates of screen data inside screentexture
static float screenText_tcw;
static float screenText_tch;

static int32_t	sample_width;
static int32_t	sample_height;
...
=================
*/
void R_Bloom_InitBackUpTexture (int32_t width, int32_t height)
{
	byte	*data;
...
void R_Bloom_InitEffectTexture (void)
{
	...
	if( BLOOM_SIZE != (int32_t)r_bloom_sample_size->value )
...
/*	if( screen_texture_width > glConfig.maxTextureSize ||
	...
	{
		r_screendownsamplingtexture_size = (int32_t)(BLOOM_SIZE * 2);
...
{
	int32_t				i;
	static int32_t		BLOOM_BLUR_RADIUS = 8;
...
void R_Bloom_GeneratexDiamonds (void)
{
	...
	{
		if ( (int32_t)r_bloom_diamond_size->value != 8 ) Cvar_SetValue( "r_bloom_diamond_size", 8 );
	...
	{
		if ( (int32_t)r_bloom_diamond_size->value != 4 ) Cvar_SetValue( "r_bloom_diamond_size", 4 );
...
void R_Bloom_DownsampleView (void)
{
	...
	if ( r_screendownsamplingtexture_size )
	{
		int32_t		midsample_width = r_screendownsamplingtexture_size * sampleText_tcw;
		int32_t		midsample_height = r_screendownsamplingtexture_size * sampleText_tch;
