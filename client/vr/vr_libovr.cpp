...
int32_t LibOVR_InitSensor(void) {
	if (fusion)
		return 1;
...
int32_t LibOVR_IsLatencyTesterAvailable(void) {
	if (latencyUtil)
		return 1;
...
int32_t LibOVR_DeviceInit(void) {
...
int32_t LibOVR_GetOrientation(float euler[3])
{
	if (!LibOVR_InitSensor())
		return 0;
...
int32_t LibOVR_GetLatencyTestColor(float color[4])
{
	OVR::Color colorOVR;
...
int32_t LibOVR_SetPredictionTime(float time) {
...
int32_t LibOVR_IsDriftCorrectionEnabled() {
